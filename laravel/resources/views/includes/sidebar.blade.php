<div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 280px; min-height: calc(100vh - 56px); height: 100%;"> <a href="/"
    ...
    <ul class="nav nav-pills flex-column mb-auto">
        ...
        <li> <a href="{{ route('products.index') }}" class="nav-link text-white"> <svg class="bi pe-none me-2"
